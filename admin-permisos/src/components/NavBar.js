...
import { House, List,FcLeave } from "react-bootstrap-icons";
      ...
      >
        <SidebarContent>
          <Menu iconShape="square">
            <MenuItem icon={<House />}>
              <div data-value="/soliciar_permiso" onClick={direct}>
                Solicitar Permiso
              </div>
            </MenuItem>
            <MenuItem icon={<House />}>
              <div data-value="/ver_permisos" onClick={direct}>
                ver permisos
              </div>
              
            </MenuItem>
            <SubMenu title="Aprobar permiso">
            <MenuItem icon={<House />}>
              <div data-value="/aprobar_permisos" onClick={direct}>
                Aprobar Permiso
              </div>
              </MenuItem>
